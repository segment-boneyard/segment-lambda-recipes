...
This is a sample template for segment-personalize - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name segment-personalize \
...
```bash
sam logs -n HelloWorldFunction --stack-name segment-personalize --tail
```
...
```bash
aws cloudformation delete-stack --stack-name segment-personalize
```
